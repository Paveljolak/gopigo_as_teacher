# Final Thesis Project - Teaching Shortest Path Algorithms Using a Physical Robot
...
- Physical Projector - to project the graphs
- GoPiGo3 Robot with GoPiGo OS - everything runs inside the robot
- Laptop or a desktop computer - to connect to the robot
- RealVNC Viewer - remote access software to see the robots desktop from your Laptop or desktop device.
